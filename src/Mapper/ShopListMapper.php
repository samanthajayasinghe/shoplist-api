...
class ShopListMapper extends DBMapper {
    ...
    public function saveShopList(ShopList $shopList) {
        ...
        $query = "INSERT INTO shop_list(name,device_id,shop_date,created_at) VALUES(?,?,?,?)";
        $this->executeQuery($query, array($shopList->getName(),$shopList->getDeviceId(), $shopList->getShopDate(), date("Y.m.d")));
